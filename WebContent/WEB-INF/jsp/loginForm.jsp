...
<body style="font-family: 微软雅黑">
	<div class="page-lock">
		<div class="page-logo" style="margin-bottom: 2px">
			<a class="brand" href="/html/login.html"
				style="font-size: 22px; color: #FFF;"> 数据管理<font color="#FFCC00">Data</font><span
		...
		<form action="login" method="post" id="loginForm">
			<div class="page-body">
				<img class="page-lock-img"
					src="${ctx}/images/joyo.png" alt="">
				<div class="page-lock-info">
					<span>&nbsp;</span> 
					<c:choose>
						<c:when test="${requestScope.message == null }">
							<span style="padding-top: 5px">登录中......</span>
						</c:when>
						<c:otherwise>
